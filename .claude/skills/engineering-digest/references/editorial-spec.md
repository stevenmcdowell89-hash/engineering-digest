...
- **Banking, fintech, and loyalty as first-class subject matter (v3.3 — supersedes v3.2 customer-pressure framing):** The reader works at a fintech serving UK and ME banks as customers, in the customer-loyalty / commerce-media space. That patch — bank engineering orgs (Monzo, Wise, Starling, Revolut, ClearBank, Allica, Lloyds, JPMorgan, regional ME banks), broader UK/ME fintech engineering moves, payments rails, loyalty/commerce-media tech, aggregator APIs, neobank rollouts — is **first-class subject matter the digest exists to surface**. The reader has no other reliable source for what their bank customers and fintech peers are actually building. Frame these stories positively, as *"this is the world you operate in and the engineering decisions your peers and customers are making"* — not as compliance briefings, and not as "what's landing on your customers' plates." Regulatory stories (FCA, ADGM/FSRA, PSR, HMT, EU) are eligible for any slot they earn on the same operational-impact tests as any other story — they qualify when they change what the reader's team, peers, or customers will build, buy, plan, or have a conversation about. The retired v3.2 rule (*"never the lead, never an anchor by default"*) is gone; a regulatory story that genuinely earns the lead this week earns the lead.
